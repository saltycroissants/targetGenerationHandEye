    ...
    public void onStartClicked(){
        ...
        if(isStartBeforeTarget())
        {
            ...
            startButton.GetComponent<MeshRenderer>().material = errorM;
                ...
                isFirst = false;
                /**
                if(Global.Condition == 1)
                {
                    setBall(RADIUS, CENTER_DISTANCE, BALLCOLOR, ballsArr);
                    isFirst = false;
                }
                else if(Global.Condition == 2)
                {
                    setBall(RADIUS *2, CENTER_DISTANCE, BALLCOLOR,ballsArr);
                    isFirst = false;
                }
                else if(Global.Condition == 3)
                {
                    setBall(RADIUS, CENTER_DISTANCE*2, BALLCOLOR,ballsArr);
                    isFirst = false;
                }
                else if(Global.Condition == 4)
                {
                    setBall(RADIUS *2, CENTER_DISTANCE*2, BALLCOLOR,ballsArr);
                    isFirst = false;
                }
                else if(Global.Condition == 5)
                {
                    setBall(RADIUS *3, CENTER_DISTANCE*2, BALLCOLOR,ballsArr);
                    isFirst = false;
                }**/
