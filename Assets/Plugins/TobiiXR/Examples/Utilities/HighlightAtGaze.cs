...
//Monobehaviour which implements the "IGazeFocusable" interface, meaning it will be called on when the object receives focus
    ...
    public class HighlightAtGaze : MonoBehaviour, IGazeFocusable
    {
        ...
        public void GazeFocusChanged(bool hasFocus)
        {
            ...
            if (hasFocus)
            {
                Debug.Log("gazing has focus");
                _targetColor = HighlightColor;
                if(gazeObject.tag == "target")
                {
                    GazeVariable.gazeAtTarget =true;
                }
                else if(gazeObject.tag == "start")
                {
                    GazeVariable.gazeAtStart =true;
            ...
            else
            {
                ...
                if(gazeObject.tag == "target")
                {
                    GazeVariable.gazeAtTarget =false;
                }
                else if(gazeObject.tag == "start")
                {
                    GazeVariable.gazeAtStart =false;
                }
            }
        }
